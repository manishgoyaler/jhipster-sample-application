...
export class JobComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-job-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-job-my-suffix div h2#page-heading span')).first();
...
export class JobUpdatePage {
  pageTitle = element(by.id('jhi-job-my-suffix-heading'));
