...
export class LocationComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-location-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-location-my-suffix div h2#page-heading span')).first();
...
export class LocationUpdatePage {
  pageTitle = element(by.id('jhi-location-my-suffix-heading'));
