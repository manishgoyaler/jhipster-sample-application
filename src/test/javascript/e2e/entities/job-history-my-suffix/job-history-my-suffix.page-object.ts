...
export class JobHistoryComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-job-history-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-job-history-my-suffix div h2#page-heading span')).first();
...
export class JobHistoryUpdatePage {
  pageTitle = element(by.id('jhi-job-history-my-suffix-heading'));
