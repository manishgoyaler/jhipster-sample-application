...
import { JobHistoryComponentsPage, JobHistoryDeleteDialog, JobHistoryUpdatePage } from './job-history-my-suffix.page-object';
...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    await navBarPage.goToEntity('job-history-my-suffix');
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.jobHistory.home.title');
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.jobHistory.delete.question');
