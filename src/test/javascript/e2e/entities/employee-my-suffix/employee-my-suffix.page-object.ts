...
export class EmployeeComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-employee-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-employee-my-suffix div h2#page-heading span')).first();
...
export class EmployeeUpdatePage {
  pageTitle = element(by.id('jhi-employee-my-suffix-heading'));
