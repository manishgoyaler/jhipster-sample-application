...
import { DepartmentComponentsPage, DepartmentDeleteDialog, DepartmentUpdatePage } from './department-my-suffix.page-object';
...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    await navBarPage.goToEntity('department-my-suffix');
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.department.home.title');
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.department.home.createOrEditLabel');
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.department.delete.question');
